...
public class Main extends Canvas{
	...
	public Main(){
		...
		handler.addObject(player = new Player(100, 100, handler, ID.Player, hud, this));
		saveGame = new SaveGame(this, hud);
		this.addKeyListener(new KeyInput(handler));

		// This creates the crashes when you die!
		// ------------------------------------------
		saveGame.openFile();
		saveGame.readFile();
		hud.maxKills = saveGame.kills;
		hud.maxLevel = saveGame.level;
		// ------------------------------------------
